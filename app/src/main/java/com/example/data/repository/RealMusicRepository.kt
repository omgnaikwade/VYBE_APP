...
class RealMusicRepository(
    ...
    private suspend fun loadFavoritesFromSupabase(userId: String) {
        try {
            ...
            Log.e(
                "RealMusicRepo",
                "Failed loading favorites from Supabase",
                e
            )
        }
    }
    ...
    private suspend fun loadHistoryFromSupabase(userId: String) {
        try {
            ...
            _listeningHistory.value = songs
            storage.saveHistory(songs)

        } catch (e: Exception) {
            Log.e(
                "RealMusicRepo",
                "Failed loading listening history",
                e
            )
        }
    }
    ...
    private suspend fun saveHistoryToSupabase(song: Song) {
        ...
        try {
            ...
            Log.e(
                "RealMusicRepo",
                "Failed saving listening history",
                e
            )
        }
    }
